...
import { FacebookIcon, Instagram, Mail, Phone, Timer, Twitter, WheatIcon, X } from "lucide-react";
...
export default function Main() {
  return (
    ...
    <Header/>
    <div className="relative w-full flex flex-col justify-center text-[white] px-20" >
      ...
      <section className="relative flex w-full mt-40 items-end">
